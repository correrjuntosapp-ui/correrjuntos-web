...
(async () => {
  const htmlPath = path.resolve(__dirname, 'reel-recuperacion-ultra.html');
  const outDir = path.resolve(__dirname, '.reel-recuperacion-preview');
  ...
  const peaks = [
    ...
    { name: '3-solution', t: 8700 },
    { name: '4-email',    t: 12700 },
    { name: '5-promise',  t: 15900 },
    { name: '6-cta',      t: 18400 },
  ];
