...
const day10Es = (name) => shell({
  ...
  body: lead(`${name || 'Crack'}, has terminado 10 días de recuperación estructurada. Ahora viene lo importante: ¿cuál es tu próxima ultra?`)
       ...
       + callout('CorrerJuntos Premium', `Plan adaptativo para tu próxima ultra · Coach IA que ajusta semana a semana · Tracking GPS · Comunidad runners cerca de ti · 4,99€/mes o 29,99€/año; si hay periodo de prueba disponible, tu tienda lo mostrará antes de confirmar.`)
...
const day10En = (name) => shell({
  ...
  body: lead(`${name || 'Crack'}, you finished 10 days of structured recovery. Now the important part.`)
       ...
       + callout('CorrerJuntos Premium', `Adaptive plan for your next ultra · AI Coach · GPS tracking · Runners community · €4.99/mo or €29.99/yr; if a trial is available, your app store will show it before you confirm.`)
