...
Now also adds:
- hasMerchantReturnPolicy (Amazon.es 30-day return standard)
- shippingDetails (Amazon.es 0-EUR, 0-1d handling, 1-3d transit)
"""
import json, re, sys, urllib.request, urllib.error
sys.stdout.reconfigure(encoding='utf-8')


# Standard Amazon.es shipping + return policy (used because affiliate URLs go to amazon.es)
RETURN_POLICY = {
...
BRAND_OVERRIDES = {
    ...
    'Nike': 'Nike', 'Asics': 'Asics', 'ASICS': 'Asics', 'Adidas': 'Adidas',
    'Brooks': 'Brooks', 'Saucony': 'Saucony', 'New': 'New Balance', 'On': 'On',
    ...
    'FlipBelt': 'FlipBelt', 'SPIbelt': 'SPIbelt', 'CamelBak': 'CamelBak',
...
PAGES = [
    ('blog/en/best-hydration-drinks-running.html', '10 Best Hydration Drinks for Running 2026', 'EUR'),
