...
(function(){
  ...
  */
  ...
  var appleBadge = '<a href="' + IOS_URL + '" target="_blank" rel="noopener" class="cro-badge" aria-label="Descargar en App Store" onclick="ga(\'cro_click\',{location:\'badge_ios\',slug:\'' + slug + '\'})">' +
  ...
  var googleBadge = '<a href="' + ANDROID_URL + '" target="_blank" rel="noopener" class="cro-badge" aria-label="Descargar en Google Play" onclick="ga(\'cro_click\',{location:\'badge_android\',slug:\'' + slug + '\'})">' +
